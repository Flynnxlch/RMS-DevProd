...
export default function ControlLevelDropdown({ id, value, onChange, error = false, openUpward = false, className = '', placeholder = 'Pilih Level Kontrol' }) {
  ...
  const selected = useMemo(() => {
    ...
    return CONTROL_LEVEL_OPTIONS.find(opt => opt === value) || null;
  }, [value]);
